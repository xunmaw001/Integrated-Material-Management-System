        ...
        <el-dialog title="审核" :visible.sync="wuziYuyueYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.wuziYuyueYesnoTypes" placeholder="请选择报名状态">
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '报名编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.wuziYuyueUuidNumber" placeholder="报名编号" clearable></el-input>
                     </el-form-item>
                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '报名状态' : ''">
                        <el-select v-model="searchForm.wuziYuyueYesnoTypes" placeholder="请选择报名状态">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wuzizongheguanlixitong/upload/wuziYuyueMuBan.xls"
                        >批量导入物资申报数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuziYuyue','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '用户邮箱': 'yonghuEmail',
                //本表字段
                     '报名编号': "wuziYuyueUuidNumber",
                     '申报理由': "wuziYuyueText",
                     '报名状态': "wuziYuyueYesnoValue",
        ...
        methods: {
            ...
            wuziYuyueUploadError(data){
                ...
                _this.form.wuziYuyueYesnoTypes = "请选择报名状态";
                _this.wuziYuyueYesnoTypesVisible = true;
            },

            wuziYuyueYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.wuziYuyueYesnoTypes == "请选择报名状态"){
