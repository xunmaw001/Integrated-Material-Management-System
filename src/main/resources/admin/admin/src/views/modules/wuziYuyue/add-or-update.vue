    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="wuziYuyueUuidNumber">
                       <el-input v-model="ruleForm.wuziYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.wuziYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="wuziYuyueUuidNumber">
                           <el-input v-model="ruleForm.wuziYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申报理由" prop="wuziYuyueText">
                        <el-input type="textarea"  :readonly="ro.wuziYuyueText" v-model="ruleForm.wuziYuyueText" placeholder="申报理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziYuyueText" label="申报理由" prop="wuziYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueYesnoTypes" label="报名状态" prop="wuziYuyueYesnoTypes">
                        <el-input v-model="ruleForm.wuziYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wuziYuyueText: [
                              { required: true, message: '申报理由不能为空', trigger: 'blur' },
                          ],
                   wuziYuyueYesnoTypes: [
                   ...
                   insertTime: [
                              { required: true, message: '物资申报时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
