    ...
    */
    ...
    public R save(@RequestBody WuziChuruInoutListEntity wuziChuruInoutList, HttpServletRequest request){
        ...
        if(wuziChuruInoutListEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",wuziChuruInoutList.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
            ...
            List<String> strings = caozuorizhiService.clazzDiff(wuziChuruInoutList, oldWuziChuruInoutListEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldWuziChuruInoutListList.toString());
        return R.ok();
    }
...
//                            wuziChuruInoutListEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",wuziChuruInoutListList.toString());
                        return R.ok();
                    }
                }
            }
